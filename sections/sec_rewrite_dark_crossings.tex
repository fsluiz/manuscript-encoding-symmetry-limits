...
The implicit-function theorem preserves a transverse equality of the two
restricted eigenvalue branches.  Symmetry keeps all inter-sector matrix
elements zero, so the equality cannot turn into an avoided crossing, while
Weyl's bound controls the isolation gap inside either block.  The complete
proof is in Appendix~\ref{app:dark-stability}.

\subsection{A finite joint-symmetry audit}

For a frozen $2\times4$ incidence instance with $k=3$,
$G_B\simeq D_4$ and the $S_3\times D_4$ fixed quotient has dimension $22$,
...
vanishes at $s=0,1$.  At $\gamma=2$, a crossing between different $D_4$
