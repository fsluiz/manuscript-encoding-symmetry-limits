...
Figure~\ref{fig:accessible-spectrum} schematically summarizes the two
distinctions used throughout the paper.  Group invariance identifies an
allowed space, while the initial state and generator algebra select the
smaller cyclic space.
...
\end{align}
Moreover, the accessible and inaccessible directions decompose shell by
shell:
\begin{align}
