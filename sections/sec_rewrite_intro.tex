...
This work makes that distinction its central question.  In the summary
below, $G_B$ denotes the faithfully represented group of base
automorphisms, $\mathcal H_{\rm sym}$ the subspace fixed by
$S_k\times G_B$, and $\mathcal K_u$ the cyclic space generated from the
uniform initial state by the endpoint Hamiltonians.  Their precise
definitions are given in Section~\ref{sec:rewrite-framework}.  The three
