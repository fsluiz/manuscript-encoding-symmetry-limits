...
$\mathcal H_{\rm sym}$ and the protocol-cyclic space $\mathcal K_u$, where
$G_B$ denotes the faithfully represented group of base automorphisms,
$\mathcal H_{\rm sym}$ the subspace fixed by $S_k\times G_B$, and
$\mathcal K_u$ the cyclic space generated from the uniform initial state by
the endpoint Hamiltonians; precise definitions are given in
Section~\ref{sec:rewrite-framework};
