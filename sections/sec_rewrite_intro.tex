...
automorphisms; this gives invariant covering penalties, exact
P\'olya--Redfield counts, and a constructive distinction between the fixed
space $\mathcal H_{\rm sym}$ and the protocol-cyclic space $\mathcal K_u$;
...
separately, a Johnson--Metropolis parent protocol whose accessible gap is
uniformly polynomial, yielding a conditional polynomial-time adiabatic
corollary.
\end{enumerate}
...
cyclic closure, sector localization, and dark multiplicity, together with a
separately controlled parent path.
