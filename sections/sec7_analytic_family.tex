...
cyclic gap at least $1024n^{-13}$.  Apply the quantitative gapped adiabatic
bound~\cite{JansenRuskaiSeiler2007} to
$H_{7s}|_{\mathcal K_J^{\rm par}}$; restriction cannot increase either
derivative norm in Eq.~\eqref{eq:cycle-parent-derivative-bounds}.  This yields
contributions of
